...
class AsphaltFunc:
    ...
    for i in AsphaltUpliftInput.distribution_uplift_asphalt:
        Pf_asphalt_uplift.append(probasphaltuplift(i, 'custom_MC'))
    ...
    # Pf_asphalt_uplift.to_excel(r'C:\Users\vandonsk5051\Documents\Afstuderen (Schijf)\Python scripts\Results\4. Asphalt\AsphaltUplift 14500000 4-10-23.xlsx')
